...
hs <- makeParamSet( 
  ...
  makeIntegerParam("min_data_in_leaf", lower=    4000L   , upper=  8000L),
...
PARAM$experimento  <- "HT8813_df9"

PARAM$input$dataset       <-  "./datasets/competencia2_2022_v9.csv"
...
PARAM$trainingstrategy$semilla_azar   <- 975433  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 975433  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy

#------------------------------------------------------------------------------
#graba a un archivo los componentes de lista
#para el primer registro, escribe antes los titulos

loguear  <- function( reg, arch=NA, folder="./exp2/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dir.create( "./exp2/",  showWarnings = FALSE ) 
dir.create( paste0( "./exp2/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd( paste0( "./exp2/", PARAM$experimento, "/") )   #Establezco el Working Directory DEL EXPERIMENTO
